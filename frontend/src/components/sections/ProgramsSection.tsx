 ...
 *
 * El movimiento vive en la entrada, no en la posición: las tarjetas se
 * descubren con una cascada irregular (0, 90, 150, 260, 340, 480ms) y cada
 * foto se asienta desde una ampliación. Ya colocadas se quedan quietas y
 * alineadas a la retícula — un parallax por columnas las desalineaba entre
 * sí y parecía un error de maquetación, no un efecto.
 *
  ...
  return (
    <section id="programas" className="relative overflow-hidden bg-isel-paper px-6 py-24 lg:py-32">
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mt-16 grid grid-cols-1 items-stretch gap-6 sm:grid-cols-2 lg:mt-20 lg:grid-cols-12 lg:gap-7">
